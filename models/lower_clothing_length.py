# -*- coding: utf-8 -*-
"""Lower_Clothing_Length.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DLrdtjbCoL5Z8LZXIAa062FrvZn-pRoT
"""
...
cleaned_data = shape_data[shape_data['lower_clothing_length']!='NA']

lower_clothing_length_counts = cleaned_data['lower_clothing_length'].value_counts()
print("Count of each class in lower_clothing_length")
print(lower_clothing_length_counts)

from sklearn.model_selection import train_test_split
lower_clothing_length_data = cleaned_data[['image_name','lower_clothing_length']]

lower_clothing_length_data.head()
...
class_0 = lower_clothing_length_data[lower_clothing_length_data['lower_clothing_length'] == 0]
class_1 = lower_clothing_length_data[lower_clothing_length_data['lower_clothing_length'] == 1]
class_3 = lower_clothing_length_data[lower_clothing_length_data['lower_clothing_length'] == 3]
class_2 = lower_clothing_length_data[lower_clothing_length_data['lower_clothing_length'] == 2]
class_4 = lower_clothing_length_data[lower_clothing_length_data['lower_clothing_length'] == 4]

target_count = 6000  # Target sample size for each class

class_0_downsampled = resample(class_0, replace=False, n_samples=target_count, random_state=42)
class_4_downsampled = resample(class_4, replace=False, n_samples=target_count, random_state=42)
class_3_downsampled = resample(class_3, replace=False, n_samples=target_count, random_state=42)


# Combine all classes
balanced_data = pd.concat([class_0_downsampled, class_1, class_2, class_3_downsampled,class_4_downsampled])
...
print(balanced_data['lower_clothing_length'].value_counts())
...
# Define the augmentation for class 1,2 to add more variation
class_1_2_transforms = transforms.Compose([
    transforms.RandomHorizontalFlip(),
...
class CustomImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = self.dataframe.iloc[idx]['lower_clothing_length']

        # Apply specific augmentation for class 1 and 2
        if label == 1 or label == 2:
            image = class_1_2_transforms(image)
        else:
...
train_data, test_data = train_test_split(balanced_data, test_size=0.2, stratify=balanced_data['lower_clothing_length'], random_state=42)

print("Training set class distribution:")
print(train_data['lower_clothing_length'].value_counts())

print("\nTesting set class distribution:")
print(test_data['lower_clothing_length'].value_counts())
...
num_classes = balanced_data['lower_clothing_length'].nunique()
...
torch.save(model.state_dict(), 'lower_clothing_model_10.pth')
...
model.load_state_dict(torch.load('lower_clothing_model_10.pth'))
model.eval()
...
class_labels = {0: "three-point", 1: "medium short", 2: "three-quarter", 3: "long", 4: "NA"}
